...
Q6 = create_multipleChoice_widget('Is the below coding compleat?',['yes','no'],'yes')
Q7 = create_multipleChoice_widget('Are thwre more examined solutions for breadth or depth?',['breadth','depth'],'breadth')
