...
Q6 = create_multipleChoice_widget('Will the code below finish in success?',['yes','no'],'yes')
Q7 = create_multipleChoice_widget('Are there more examined solutions for breadth or depth?',['breadth','depth'],'breadth')
Q8 = create_multipleChoice_widget('At any point does breadth or depth have a bigger open list?',['breadth','depth'],'breadth')
