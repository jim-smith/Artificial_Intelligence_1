...
def MarkClassifier(): 
        ...
        for setNum in range(len(datasets)):
            ...
            try:
                ...
                message += ("So you score 0 for this attempt.\n"
                            "qOtherwise trace through the  message printed above"
            ...
            try:
                ...
                #print(str(e))
                message = ( "your code failed to run when asked to fit and predict a dataset "
                            "and produced this error message:\n "
    ...
    if (numConstantPreds >0):
        message += (f"To help you improve your code, note that in {numConstantPreds} runs "
                    "your algorithmn always made the same prediction.\n"
                   )
    finalScore = 0
    if (madeInvalid>0):
