...
# pre_submission_test.py
# code to provide some feedback to avoid student errors
# prior to submission
# Jim Smith 2023
...
from myVisualiser import cluster_and_visualise as student
...
#quick version of Rhys; code here
def processError(e,func='cluster_and_visualise'):
    exceptionInfo = EXC();
...
#dummy data
feature_names= ( 'mean_red', 'mean_green', 'mean_blue','width', 'height', 'weight')
...
if(score>0):
    print('This scores >0 so can be submitted. '
          ...
          ' against the marking criteria, to see if you can get more marks.\n'
         )
else:
    print('This is not ready to submit as exceptions are being thrown.\n'
          'Fix these before you submit or you will be wasting an attempt.\n'
          f' The error messages are:\n{message}'
         )
